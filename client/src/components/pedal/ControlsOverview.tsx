              ...
              <div>
                <div className="flex items-center justify-between pb-4 border-b border-[#F0D3B8] mb-4">
                  <div className="flex items-center gap-3.5">
                    ...
                    <div>
                      <h3 className="text-2xl font-editorial font-bold text-[#2A1A12]">{ctrl.label}</h3>
                      <span className="text-[10px] font-mono-tech text-[#8A6A54] uppercase tracking-widest">{ctrl.range}</span>
                    </div>
                  </div>
                  <span className="text-xs font-mono-tech text-[#FF5E1E] font-bold">16mm ALPHA</span>
                </div>

                <p className="text-xs sm:text-sm text-[#8A6A54] leading-relaxed mb-6 font-light">
                  {ctrl.description}
                </p>
              </div>

              {/* Sweet Spots */}
              <div className="bg-[#FFF1E6] p-4 sm:p-5 rounded-2xl border border-[#F0D3B8] space-y-2">
                ...
                {ctrl.sweetSpots.map((spot, i) => (
                  <div key={i} className="text-xs font-mono-tech flex items-start gap-2 text-[#8A6A54]">
                    <span className="text-[#2A1A12] font-bold shrink-0">{spot.setting}:</span>
